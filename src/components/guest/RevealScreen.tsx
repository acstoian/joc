...
// TODO(05-02): Replace this placeholder with the full reveal + distribution + leaderboard implementation.

/**
 * RevealScreen — placeholder for phase "revealed" (PLAY-05, PLAY-06).
      ...
      <Card className="glass w-full max-w-[360px] border-0">
        <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
          ...
          <p className="text-base text-champagne font-heading">
            Răspuns corect: {state.correctOption ?? "—"}
          </p>
